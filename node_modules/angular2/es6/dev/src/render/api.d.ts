...
export declare class RenderProtoViewMergeMapping {
    ...
    constructor(mergedProtoViewRef: RenderProtoViewRef, fragmentCount: number, mappedElementIndices: number[], mappedTextIndices: number[], hostElementIndicesByViewIndex: number[], nestedViewCountByViewIndex: number[]);
}
