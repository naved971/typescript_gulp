...
export let DomRenderer = class extends Renderer {
    constructor(_eventManager, document, reflectPropertiesAsAttributes) {
        super();
...
DomRenderer = __decorate([
    Injectable(),
    __param(1, Inject(DOCUMENT_TOKEN)),
    __param(2, Inject(DOM_REFLECT_PROPERTIES_AS_ATTRIBUTES)), 
    __metadata('design:paramtypes', [EventManager, Object, Boolean])
], DomRenderer);
