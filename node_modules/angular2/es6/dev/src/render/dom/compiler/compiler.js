...
export class DomCompiler extends RenderCompiler {
    constructor(_stepFactory, _viewLoader, _useNativeShadowDom) {
        super();
...
export let DefaultDomCompiler = class extends DomCompiler {
    constructor(parser, shadowDomStrategy, viewLoader) {
        super(new DefaultStepFactory(parser, shadowDomStrategy), viewLoader, shadowDomStrategy.hasNativeContentElement());
    }
};
