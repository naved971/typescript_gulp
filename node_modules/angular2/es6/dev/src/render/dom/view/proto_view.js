...
export class DomProtoView {
    constructor(type, rootElement, elementBinders, rootTextNodeIndices, boundTextNodeCount, fragmentsRootNodeCount, isSingleElementFragment) {
        this.type = type;
    ...
    static create(type, rootElement, fragmentsRootNodeCount, rootTextNodeIndices, elementBinders) {
