...
export let Compiler = class {
    ...
    compileInHost(componentTypeOrBinding) {
        ...
        if (isPresent(hostAppProtoView)) {
            ...
            hostPvPromise =
                this._render.compileHost(directiveMetadata)
                    .then((hostRenderPv) => {
                    var protoView = this._protoViewFactory.createAppProtoViews(componentBinding, hostRenderPv, [componentBinding]);
        ...
        return hostPvPromise.then(hostAppProtoView => this._mergeUnmergedProtoViews().then(_ => hostAppProtoView.ref));
    }
    _mergeUnmergedProtoViews() {
    ...
    _compile(componentBinding) {
        ...
        resultPromise = this._render.compile(renderTemplate)
            .then((renderPv) => {
            var protoView = this._protoViewFactory.createAppProtoViews(componentBinding, renderPv, boundDirectives);
    ...
    _compileNestedProtoViews(renderProtoView, appProtoView, componentType) {
    ...
    _collectMergableProtoViews(appProtoView, componentType) {
    ...
    _loopComponentElementBinders(appProtoView, callback) {
