...
export declare class DomProtoView {
    ...
    static create(type: ViewType, rootElement: Element, fragmentsRootNodeCount: number[], rootTextNodeIndices: number[], elementBinders: List<DomElementBinder>): DomProtoView;
    constructor(type: ViewType, rootElement: Element, elementBinders: List<DomElementBinder>, rootTextNodeIndices: number[], boundTextNodeCount: number, fragmentsRootNodeCount: number[], isSingleElementFragment: boolean);
}
