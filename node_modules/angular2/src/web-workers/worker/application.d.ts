 ...
 */
export declare function bootstrapWebworker(appComponentType: Type, componentInjectableBindings?: List<Type | Binding | List<any>>, errorReporter?: Function): Promise<ApplicationRef>;
