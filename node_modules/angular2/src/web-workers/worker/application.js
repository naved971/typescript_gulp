 ...
 */
function bootstrapWebworker(appComponentType, componentInjectableBindings, errorReporter) {
...
var WorkerMessageBusSource = (function () {
    ...
    WorkerMessageBusSource.prototype.listen = function (fn) { addEventListener("message", fn); };
