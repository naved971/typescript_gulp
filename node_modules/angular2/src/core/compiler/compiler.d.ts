...
export declare class Compiler {
    ...
    private _mergeUnmergedProtoViews();
    ...
    private _compileNestedProtoViews(renderProtoView, appProtoView, componentType);
    private _collectMergableProtoViews(appProtoView, componentType);
    private _loopComponentElementBinders(appProtoView, callback);
